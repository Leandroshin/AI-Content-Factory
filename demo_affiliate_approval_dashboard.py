...
def main() -> None:
    ...
    _check("Nova oferta manual" in html, "HTML includes manual offer form")
    _check("new-offer-form" in html, "HTML has manual intake form id")
    ...
    _check('fetch("/api/offers"' in html, "HTML can submit manual offers to local backend")
